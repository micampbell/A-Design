...
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defun agent-cheap-upper-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
    ...
    (with-open-file 
	 ...
	 ((null comp) 
	  (let ((comp (find-the-component candidates 2 0 'inverse)))
...
(defun agent-cheap-middle-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'max)))
    (with-open-file 
...
(defun agent-cheap-lower-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'max)))
    (with-open-file 
...
(defun agent-light-upper-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'max)))
    (with-open-file 
     ...
     (do* ((file-vars (get-or-initialize-comp-file-vars iofile))
	  ...
	  (comp (read iofile nil nil) (read iofile nil nil)))
	 ((null comp) 
	  (let ((comp (find-the-component candidates 2 1 'inverse)))
	    (setf (sc-components concept) 
		  (mod-list (sc-components concept) i comp))
	    (setf (sc-i-agents concept)
		  (mod-list (sc-i-agents concept) i 
...
(defun agent-light-middle-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'max)))
    (with-open-file 
...
(defun agent-light-lower-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'max)))
    (with-open-file 
...
(defun agent-efficient-upper-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'max)))
    (with-open-file 
     ...
     (do* ((file-vars (get-or-initialize-comp-file-vars iofile))
	  ...
	  (comp (read iofile nil nil) (read iofile nil nil)))
	 ((null comp) 
	  (let ((comp (find-the-component candidates 2 2 'inverse)))
	    (setf (sc-components concept) 
		  (mod-list (sc-components concept) i comp))
	    (setf (sc-i-agents concept)
		  (mod-list (sc-i-agents concept) i 
...
(defun agent-efficient-middle-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'max)))
    (with-open-file 
...
(defun agent-efficient-lower-mg-most-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'max)))
    (with-open-file 
...
(defun agent-cheap-upper-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
...
(defun agent-cheap-middle-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'min)))
    (with-open-file 
...
(defun agent-cheap-lower-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'min)))
    (with-open-file 
...
(defun agent-light-upper-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'min)))
    (with-open-file 
...
(defun agent-light-middle-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'min)))
    (with-open-file 
...
(defun agent-light-lower-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'min)))
    (with-open-file 
...
(defun agent-efficient-upper-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'min)))
    (with-open-file 
...
(defun agent-efficient-middle-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'min)))
    (with-open-file 
...
(defun agent-efficient-lower-mg-least-used-datum (concept &optional todo taboo)
  (let* ((i (position nil (sc-components concept)))
	 (eb (nth i (sc-embodiments concept)))
	 (datum-pos (datum-position eb i concept :choose 'min)))
    (with-open-file 
...
(defun find-the-component (cands pos1 pos2 method &optional rand-num nums)
  (cond ((null rand-num) 
	 (cond 
	...
	((> (- rand-num (car nums)) 0) 
	 (find-the-component (cdr cands) pos1 pos2  nil
